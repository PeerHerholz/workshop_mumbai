...
RUN echo '{ \
    ...
    \n    [ \
    \n      "run", \
    \n      "curl -J -L -o /data/dataset.zip https://www.dropbox.com/sh/fvvium3z3l0wedo/AACkFi2mhWZkcqwmHjO8WwUra?dl=1 && mkdir /data/dataset && unzip /data/dataset.zip -d /data/dataset/ -x /" \
    \n    ], \
    \n    [ \
    \n      "run", \
    \n      "curl -J -L -o /output/datasink.zip https://www.dropbox.com/sh/dcm0owd4g0028nf/AAAqtZZPusTwbhBrygKXqQNna?dl=1 && mkdir /output/datasink && unzip /output/datasink.zip -d /output/datasink/ -x /" \
    \n    ], \
    \n    [ \
    \n      "copy", \
    \n      [ \
